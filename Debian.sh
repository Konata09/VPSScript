...
apt update && apt install -y unzip htop vim git curl wget net-tools network-manager zsh libncursesw5-dev autotools-dev autoconf build-essential iperf3 neofetch grc
